...
const Register = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#050507] text-zinc-200 font-mono overflow-hidden px-6">
      ...
      {/* Small Tech Details */}
      <div className="absolute top-4 left-4 text-[9px] text-zinc-700 select-none">REGISTRATION_GATE // GATE_02</div>
      ...
      <div className="w-full max-w-md bg-[#0a0a0f] border border-zinc-900 rounded p-8 relative shadow-[0_20px_50px_rgba(0,0,0,0.7)] z-10">
        ...
        <div className="flex flex-col gap-1 border-b border-zinc-900 pb-4 mb-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] uppercase font-bold tracking-widest text-red-500/80">Create Access Node</span>
          </div>
          <h2 className="text-2xl font-black tracking-tight text-white uppercase">INITIALIZE_REG</h2>
        </div>

        {/* Form - Hooked up submithandle & kept autoComplete="off" */}
        <form className="space-y-5" onSubmit={submithandle} autoComplete="off">
          
          {/* Email Input */}
          <div className="flex flex-col gap-2">
            <label className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">[01] Email Address</label>
            <input 
              type="email" 
              name="email" 
              value={email} 
          ...
          {/* Username Input */}
          <div className="flex flex-col gap-2">
            <label className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">[02] Choose Username</label>
            <input 
              type="text" 
              name="username" 
              value={username} 
          ...
          {/* Password Input */}
          <div className="flex flex-col gap-2">
            <label className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">[03] Secure Password</label>
            <input 
              type="password" 
              name="password" 
              value={password} 
